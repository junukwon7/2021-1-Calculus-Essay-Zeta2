...
\title{Various Methods for \\Calculating $\boldsymbol\zeta$(2)} % 제목
\tagline{Evaluating the value of the infinite sum of $1/{n^2}$\\As known as the Basel problem} % 부제
\author{Junu Kwon} % 이름
\koauthor{19007 권준우}
\department{2021 Calculus I}
\degreedate{\today}
\authorID{}
\cosupervisor{}
\faculty{}
